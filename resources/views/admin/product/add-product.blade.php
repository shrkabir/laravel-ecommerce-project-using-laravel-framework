        ...
        <div class="panel-body">
          ...
          {{Form::open(['route'=>'new-product', 'method'=>'POST', "class"=>"form-horizontal", "enctype"=>"multipart/form-data"])}}
            ...
            <div class="form-group">
              ...
              <div class="col-md-9">
                <textarea class="form-control" id="editor" name="product_long_description"></textarea>
            ...
            <div class="form-group">
              <div class="col-md-9 col-md-offset-3">
                <input type="submit" name="add_brand_btn" class="btn btn-success btn-block" value="Save Product"/>
              </div>
            </div>
          {{Form::close()}}
        </div>
